  ...
  return (
    <div className="relative flex items-center">
      ...
      <Link
        ...
        ref={scheduleRef}
        href={"/"}
        className="relative z-10 text-black md:px-8 bg-gradient-to-b from-[#FFFAF7] to-[rgba(247,247,247,0.72)] min-w-[240px] font-base  font-medium px-6 py-2.5 rounded-full bg-[] tex transition-colors text-xl will-change-transform"
      >
