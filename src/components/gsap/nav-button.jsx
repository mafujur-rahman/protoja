...
const CustomNavButton = ({ href, label, leftbg="#F76F00", rightbg="#F76F00" ,buttonBg="none",textColor="#F76F00"}) => {
  ...
  return (
    <div className="relative flex items-center">
      <div
        ref={leftArrowRef}
        className={` bg-[${leftbg}] h-12 w-12 rounded-full flex items-center justify-center opacity-0 absolute left-[-44px] `}
      >
        <svg
          ref={leftArrowSvg}
          width="24"
      ...
      <div
        ref={rightArrowRef}
        className={`bg-[${rightbg}] h-12 w-12 rounded-full flex items-center justify-center relative z-20`}
      >
        <svg
          ref={rightArrowSvg}
          width="24"
